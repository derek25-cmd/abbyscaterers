...
import { FileText, Loader2, Download, ArrowLeft, UserCheck, UserX, User } from "lucide-react";
...
export default function MonthlyAttendanceReportPage() {
  ...
  }, [selectedMonth, records, employees]);
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle>Attendance Summary for: {format(parseISO(`${selectedMonth}-01`), 'MMMM yyyy')}</CardTitle></CardHeader>
        <CardContent>
           <Table>
