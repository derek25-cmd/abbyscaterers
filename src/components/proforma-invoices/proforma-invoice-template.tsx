            ...
            <Card id="proforma-invoice-pdf-content" className="p-8 bg-white text-black print:shadow-none" style={{ fontFamily: 'sans-serif', minHeight: '297mm', fontSize: '15px' }}>
                <div className="relative" style={{ paddingBottom: '80px' }}>
                    ...
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <h2 className="font-bold text-4xl" style={{letterSpacing: '0.1em'}}>PROFORMA INVOICE</h2>
                        <div className="mt-1 text-base space-y-0">
                            <p><strong>Date:</strong> {formatDate(invoiceDate)}</p>
                            <p><strong>Proforma Invoice No.:</strong> {id || '{Invoice No.}'}</p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-end mt-8">
                        <div className="text-base space-y-2">
                            ...
                            <div className="grid grid-cols-[max-content_auto] gap-x-4 gap-y-1">
                             ...
                             <p className="font-bold pt-4">Terms & Conditions:</p>
