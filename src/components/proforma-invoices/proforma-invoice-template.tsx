    ...
    return (
        <>
            <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1, padding: '1.5cm' }}>
                    <Card id="proforma-invoice-pdf-content" className="p-8 bg-transparent text-black print:shadow-none shadow-none border-none" style={{ fontFamily: 'sans-serif', minHeight: '297mm', fontSize: '15px' }}>
                        <div className="flex flex-col h-full">
                            {/* HEADER SECTION */}
                            <div className="flex justify-end items-start mb-2 relative pt-20">
